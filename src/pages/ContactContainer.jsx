      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:flex sm:items-center sm:justify-between">
          <animated.div style={imageAnimation} className="sm:flex-1">
            <img src={landing_img} alt="Landing" className="rounded-lg shadow-lg" />
          </animated.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:border-teal-500 focus:ring-teal-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:border-teal-500"
                  required
                />
              </div>
              <div>

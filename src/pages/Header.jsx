...
export default function Header() {
  return (
    <header className="fixed w-full shadow-sm">
      <nav className="bg-white border-gray-200 py-3 dark:bg-gray-900">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          <a href="#" className="flex items-center">
            ...
            <span className="self-center text-2xl whitespace-nowrap text-teal-500 font-extrabold">Nixod</span>
          </a>
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <a
                  href="#"
                  className="
                    block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100
              ...
              <li>
                <a href="#" className="block py-2 pl-3 pr-4 text-gray-700 border-b
